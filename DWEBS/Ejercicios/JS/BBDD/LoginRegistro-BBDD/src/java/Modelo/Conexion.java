...
public class Conexion {
    ...
    //----------------------------------------------------------
    public void Insertar_Dato(String tabla, String nombre, String apellido, String password, String genero, String fecha, boolean dwc, boolean dws, boolean di, String curso) throws SQLException 
    {
        String Sentencia = "INSERT INTO " + tabla + " VALUES ('" + nombre + "'," + "'" + apellido + "','" + password + "','" + genero + "','" + fecha + "','" + dwc + "','" + dws + "','" + di + "','" + curso + "')";
