...
public class ConexionEstatica {
    ...
    public static Usuario existeUsuario(String usuario) {
        ...
        try {
            ...
            {
                existe = new Usuario(Conj_Registros.getString("nombre"), Conj_Registros.getString("apellidos"), Conj_Registros.getString("password"));
            }
        } catch (SQLException ex) {
    ...
    public static LinkedList obtenerUsuarios() {
        ...
        try {
            ...
            while(Conj_Registros.next()){
                user = new Usuario(Conj_Registros.getString("nombre"), Conj_Registros.getString("apellidos"), Conj_Registros.getString("password"), Conj_Registros.getString("genero"), Conj_Registros.getString("fecha"),Conj_Registros.getBoolean("dwc"),Conj_Registros.getBoolean("dws"),Conj_Registros.getBoolean("di"),Conj_Registros.getString("curso"));
                usuariosBD.add(user);
            }
        } catch (SQLException ex) {
        }
...
//            ConexionEstatica.Conj_Registros = ConexionEstatica.Sentencia_SQL.executeQuery(sentencia);
//            while(Conj_Registros.next()){
//                user =new Usuario(Conj_Registros.getString("DNI"), Conj_Registros.getString("nombre"), Conj_Registros.getInt("Tfno"));;
