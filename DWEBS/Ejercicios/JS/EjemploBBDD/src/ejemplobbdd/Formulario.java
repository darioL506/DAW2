...
public class Formulario extends javax.swing.JFrame {
    ...
    public Formulario() {
        initComponents();
        co = new Conexion();
        co.obtenerDatosTabla(Constantes.TablaPersonas);

        CT_DNI.setText(co.obtenerPrimer("DNI"));
        CT_Nombre.setText(co.obtenerPrimer("Nombre"));
        CT_Tfno.setText(co.obtenerPrimer("Tfno"));
    }

    public Formulario(Conexion co) {
        initComponents();
        this.co = co;
        this.co.abrirConexion();
        co.obtenerDatosTabla(Constantes.TablaPersonas);
        CT_DNI.setText(co.obtenerPrimer("DNI"));
        CT_Nombre.setText(co.obtenerPrimer("Nombre"));
        CT_Tfno.setText(co.obtenerPrimer("Tfno"));
        this.co.cerrarConexion();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Ejemplo conexión NO estática");
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(4, 0, 0, 50);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(4, 6, 0, 50);
        ...
        gridBagConstraints.ipadx = 4;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(5, 6, 0, 50);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(6, 29, 26, 0);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(6, 6, 26, 50);
...
private void BT_PrimActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BT_PrimActionPerformed
    this.co.abrirConexion();
    if (!this.co.obtenerPrimer("DNI").isEmpty()) {
        CT_DNI.setText(co.obtenerPrimer("DNI"));
        CT_Nombre.setText(co.obtenerPrimer("Nombre"));
        CT_Tfno.setText(co.obtenerPrimer("Tfno"));
    } else {
...
private void BT_UltActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BT_UltActionPerformed
    this.co.abrirConexion();
    if (!co.obtenerUltimo("DNI").isEmpty()) {
        CT_DNI.setText(co.obtenerUltimo("DNI"));
        CT_Nombre.setText(co.obtenerUltimo("Nombre"));
        CT_Tfno.setText(co.obtenerUltimo("Tfno"));
    } else {
...
private void BT_AntActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BT_AntActionPerformed
    this.co.abrirConexion();
    if (co.irAnterior()) {
        CT_DNI.setText(co.obtenerActual("DNI"));
        CT_Nombre.setText(co.obtenerActual("Nombre"));
        CT_Tfno.setText(co.obtenerActual("Tfno"));
    } else {
...
private void BT_AñadirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BT_AñadirActionPerformed
    this.co.abrirConexion();
    int cod = co.insertarDato(Constantes.TablaPersonas, CT_DNI.getText(), CT_Nombre.getText(), Integer.parseInt(CT_Tfno.getText()));
    if (cod == 0) {
...
private void BT_BorrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BT_BorrarActionPerformed
    co.abrirConexion();
    int cod = co.borrarDato(Constantes.TablaPersonas, CT_DNI.getText());
    if (cod == 0) {
...
private void BT_ModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BT_ModificarActionPerformed
    this.co.abrirConexion();
    int cod = co.modificarDato(Constantes.TablaPersonas, CT_DNI.getText().trim(), CT_Nombre.getText().trim());
    if (cod == 0) {
